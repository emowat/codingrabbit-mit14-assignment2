# Assignment 2: Effective Programming in C and C++
...
## Step 3: Review Coding Examples from Lecture 4 & 5
Inside this repository, you will find two folders: `lecture-04-examples` and `lecture-05-examples`.
...
* `problem1/` - Linked List Manipulation
* `problem2/` - Minimum Spanning Tree
* `problem3/` - Rational Numbers
...
2. Click on the `.c` file (e.g., `list.c`) to open it in your editor and begin working!
...
1. `git remote add upstream https://github.com/emowat/codingrabbit-mit14-assignment2.git` *(one-time setup — links you to the original course repository; skip this if you've already done it once)*
